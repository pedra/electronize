...
APP_PAGE = {
    ...
    config: {
        title: 'Cadastro de Tipo de Nota',
        tipo: 'tipo_nota',

        list: SERVER_URL + '/cadastro/tipo_nota/search/',
        find: SERVER_URL + '/cadastro/tipo_nota/find/',
        save: SERVER_URL + '/cadastro/tipo_nota/save/',
        delete: SERVER_URL + '/cadastro/tipo_nota/delete/',
    ...
    edit: function(id) {
        ...
        SERVER.send(APP_PAGE.config.find, {
            ...
            $('#tipo_nota').dropdown('set selected', data.row.tipo_nota);
            $('#origem').dropdown('set selected', data.row.origem);
    ...
    save: function() {
        ...
        if (data.tipo_nota == 0) {
            $("#tipo_nota").focus();
           return report('É obrigatório indicar um <b>Tipo</b>!', ALERT);
        }

        if (data.origem == 0) {
            $("#origem").focus();
           return report('É obrigatório indicar um <b>Origem</b>!', ALERT);
        }
