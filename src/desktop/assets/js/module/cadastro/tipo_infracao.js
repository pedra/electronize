...
APP_PAGE = {
    ...
    config: {
        title: 'Cadastro de Tipo de Infração',
        tipo: 'tipo_infracao',

        list: SERVER_URL + '/cadastro/tipo_infracao/search/',
        find: SERVER_URL + '/cadastro/tipo_infracao/find/',
        save: SERVER_URL + '/cadastro/tipo_infracao/save/',
        delete: SERVER_URL + '/cadastro/tipo_infracao/delete/',
    ...
    showList: function(data, query) { //console.log(data)
    ...
    edit: function(id) {
        ...
        SERVER.send(APP_PAGE.config.find, {
            ...
            $('#ponto').val(data.row.ponto);
            $('#classificacao').val(data.row.classificacao);
    ...
    save: function() {
        ...
        if (data.codigo.trim() == '') {
            $("#codigo").focus();
            return report('É obrigatório indicar um <b>Código</b>!', ALERT);
        }

        if (data.ponto.trim() == '') {
            $("#ponto").focus();
            return report('É preciso indicar os Pontos!', WARN);
        }

        if (data.classificacao.trim() == '') {
            $("#classificacao").focus();
            return report('É preciso indicar a Classificação!', WARN);
        }
