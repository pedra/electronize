...
APP_PAGE = {
    ...
    config: {
        ...
        report: SERVER_URL + '/cadastro/infracao/report'
    },
    ...
    showModal: function(table){
        ...
        APP_PAGE.modal = window.open(APP_LANCAMENTO.template.relatorio, 'Relatório de Infrações')

        APP_PAGE.modal.onload = function(){
            APP_PAGE.modal.document.getElementById('content').innerHTML = table;
            APP_PAGE.modal.document.getElementById('title').innerHTML = 'Relatório de Infrações';
        }
    }
}
