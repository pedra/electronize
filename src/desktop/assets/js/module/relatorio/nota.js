...
APP_PAGE = {
    ...
    config: {
        title: 'Relatório de Nota',
        tipoNotas: SERVER_URL + '/cadastro/tipo_nota/list/',
        report: SERVER_URL + '/cadastro/nota/report'
    },
 ...
 // Pegando a listagem de Fornecedor
    getTipoNotasR: function(unSelected){

        var unSelected = unSelected || false;

        SERVER.send(APP_PAGE.config.tipoNotas, {}, function(data){
