...
APP_PAGE = {
    ...
    config: {
        title: 'Cadastro de Tipo de Oredem de serviço',
        tipo: 'tipo_os',

        list: SERVER_URL + '/cadastro/tipo_os/search/',
        find: SERVER_URL + '/cadastro/tipo_os/find/',
        save: SERVER_URL + '/cadastro/tipo_os/save/',
        delete: SERVER_URL + '/cadastro/tipo_os/delete/',
